                ...
                <form onSubmit={form.handleSubmit(submitForm)} className="flex flex-col md:flex-row gap-4 md:gap-8">
                    ...
                    <div className="flex flex-col gap-4 w-full max-w-xs">
                        ...
                        <div className="flex gap-2">
                            <Button type="submit" className="w-3/4" variant="default" title="Save Customer">Save Customer</Button>
                            <Button type="button" className="w-1/4" variant="destructive" title="Cancel" onClick={() => form.reset(defaultValues)}>Cancel</Button>
                        </div>
                    </div>
                </form>
        </Form>
